...
#include "2.h"
int scroll(SDL_Surface *ecran, SDL_Surface *imageDeFond, SDL_Surface *imageDePerso,  SDL_Rect positionFond ,SDL_Rect positionmilieu)
{
   ...
   //definition des coordonnées ( sur axe (x,y) et largeur + hauteur)
    ...
    imageDeFond = IMG_Load("backgr.png");//chargement de l'image
    imageDePerso = IMG_Load("ini.png");//chargement de l'image
